...
A API do warezcdnfoi projetada para facilitar a integração de conteúdo multimídia em qualquer plataforma. Nossa solução oferece endpoints RESTful simples, rápidos e documentados para acesso a filmes, séries, animes e doramas.
...
https://warezcdn.sbs/lista?category=animes&type=tmdb&format=json&order=asc
...
https://warezcdn.sbs/lista?category=animes&format=json
https://warezcdn.sbs/lista?category=filme&type=imdb&format=json
https://warezcdn.sbs/lista?category=serie&type=tmdb&order=asc&format=json
https://warezcdn.sbs/lista?category=dorama&format=html
Guia de programação XMLTV
Guia de programação dos canais em XMLTV, atualizado a cada 24h.
https://warezcdn.sbs/lista?category=guia
Canais
Use esta categoria para obter a lista pública de canais com dados de navegação, reprodução e filtros.
https://warezcdn.sbs/lista?category=canais&format=json
https://warezcdn.sbs/lista?category=canais&q=sportv&format=json
https://warezcdn.sbs/lista?category=canais&genre=esportes&limit=20&format=json
Categorias de canais
Use esta categoria para obter as categorias públicas disponíveis para navegação de canais.
https://warezcdn.sbs/lista?category=channel_categories&format=json
Eventos esportivos
...
https://warezcdn.sbs/lista?category=eventos&format=json
https://warezcdn.sbs/lista?category=eventos&sport=futebol&format=json
https://warezcdn.sbs/lista?category=eventos&sport=golfe&format=json
https://warezcdn.sbs/lista?category=eventos&status=live&limit=10&format=json
https://warezcdn.sbs/lista?category=eventos&q=flamengo&format=json
Categorias de eventos
Use esta categoria para obter as categorias e agrupamentos usados pelos eventos esportivos.
https://warezcdn.sbs/lista?category=event_categories&format=json
Pesquisa
...
https://warezcdn.sbs/lista?category=pesquisa&q=gremio&format=json
https://warezcdn.sbs/lista?category=busca&q=espn&limit=15&format=json
...
Gêneros em /lista
Listar gêneros
https://warezcdn.sbs/lista?category=filme&type=generos&format=json
https://warezcdn.sbs/lista?category=serie&type=generos&format=json
https://warezcdn.sbs/lista?category=anime&type=generos&format=json
https://warezcdn.sbs/lista?category=dorama&type=generos&format=json
Listar IDs por gênero
https://warezcdn.sbs/lista?category=filme&type=imdb&genero=acao&format=json
https://warezcdn.sbs/lista?category=serie&type=tmdb&genero=drama&format=json
https://warezcdn.sbs/lista?category=anime&type=tmdb&genero=shounen&format=json
https://warezcdn.sbs/lista?category=dorama&type=tmdb&genero=romance&format=json
...
https://warezcdn.sbs/calendario.php
Filmes
Acesse filmes via ID do IMDb (iniciado com tt) ou ID numérico do TMDB.

https://warezcdn.sbs/filme/ID_DO_FILME
...
https://warezcdn.sbs/serie/ID_TMDB
Exemplo: /serie/1396
...
<script> var type = "serie"; var id = "1396"; var season = "1"; var episode = "1"; function EmbedPlayer(t,i,s,e){ if(t=="filme"){s="";e=""} var f=document.getElementById("PlayerContainer"); var u="https://warezcdn.sbs/"+t+"/"+i+"/"+s+"/"+e; u = u.replace(/([^:])(\/{2,})/, "$1/"); f.innerHTML='<iframe src="'+u+'" width="100%" height="100%" frameborder="0" allow="autoplay *; encrypted-media *; picture-in-picture *; fullscreen *; clipboard-write *; accelerometer *; gyroscope *; web-share *" allowfullscreen webkitallowfullscreen mozallowfullscreen></iframe>'; } EmbedPlayer(type,id,season,episode);
</script>
Plugin PHP
<div id="PlayerContainer">
<?php $type = "serie"; $id = "1396"; $season = "1"; $episode = "1"; function RenderPlayer($t, $i, $s, $e) { if ($t == "filme") { $s = ""; $e = ""; } $baseUrl = 'https://warezcdn.sbs'; $u = $baseUrl. '/'. $t. '/'. $i. '/'. $s. '/'. $e; $u = preg_replace('/([^:])(\/{2,})/', '$1/', $u); echo '<iframe src="'. $u. '" width="100%" height="100%" frameborder="0" allow="autoplay *; encrypted-media *; picture-in-picture *; fullscreen *; clipboard-write *; accelerometer *; gyroscope *; web-share *" allowfullscreen webkitallowfullscreen mozallowfullscreen></iframe>'; } RenderPlayer($type, $id, $season, $episode);?>
</div>
Personalização
...
Telegram
DMCA
© 2026 warezcdn. Todos os direitos reservados.
